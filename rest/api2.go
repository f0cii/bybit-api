...
func (b *ByBit) GetPriceIndex(symbol string, resolution int, from string, to string) (query string, resp []byte, result []FundingData, e error) {
	var ret FundingResult
	params := map[string]interface{}{}
	params["symbol"] = symbol
...
func (b *ByBit) GetPremiumIndex(symbol string, resolution int, from string, to string) (query string, resp []byte, result []FundingData, e error) {
	var ret FundingResult
	params := map[string]interface{}{}
	params["symbol"] = symbol
	params["resolution"] = resolution
...
func (b *ByBit) LinearGetPriceIndex(symbol string, resolution int, from string, to string) (query string, resp []byte, result []FundingData, e error) {
	var ret FundingResult
	params := map[string]interface{}{}
	params["symbol"] = symbol
	params["resolution"] = resolution
...
func (b *ByBit) LinearGetPremiumIndex(symbol string, resolution int, from string, to string) (query string, resp []byte, result []FundingData, e error) {
	var ret FundingResult
	params := map[string]interface{}{}
	params["symbol"] = symbol
	params["resolution"] = resolution
